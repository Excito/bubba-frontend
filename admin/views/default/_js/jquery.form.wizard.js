...
(function($){
	$.widget("ui.formwizard", {
		...
		_init: function() {
            ...
            this.nextButton = (this.options.next instanceof jQuery ?  this.options.next : this.element.find(this.options.next))
					.click(function() {
						return wizard._next();
					});
            ...
            this.backButton = (this.options.back instanceof jQuery ?  this.options.back : this.element.find(this.options.back))
                .click(function() {
